  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" >
    ...
    <ul class="navbar-nav ml-auto">
      <!-- Navbar Search -->
      <!--  000ELIMINAÇÃOD DA BARRA PESQUISAR 1-->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
            <img src="painel/assets/img/Foto Juliana.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
       ...
       <!--  000ELIMINAÇÃOD DA BARRA PESQUISAR lATERAL-->
